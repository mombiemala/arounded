    ...
    <div className="min-h-screen bg-ground text-ink relative overflow-hidden">
      ...
      <div className={`${wrap} relative py-16`}>
        ...
        <section className={`${section} mt-4`}>
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight mb-5">
        ...
        <section className={section}>
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight mb-6">Data stored with login</h2>
        ...
        <section className={section}>
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight mb-6">What we don&apos;t store</h2>
        ...
        <section className={section}>
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight mb-6">Third-party services</h2>
        ...
        <section className={section}>
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight mb-5">Cookies &amp; local storage</h2>
        ...
        <section className={section}>
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight mb-5">Data retention</h2>
          <div className="space-y-4 opacity-80 leading-relaxed max-w-2xl text-[15px]">
            <p>
        ...
        <section className={section}>
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight mb-5">Security</h2>
          <div className="space-y-4 opacity-80 leading-relaxed max-w-2xl text-[15px]">
            <p>
        ...
        <section className={section}>
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight mb-6">Your choices</h2>
        ...
        <section className={section}>
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight mb-5">Contact</h2>
