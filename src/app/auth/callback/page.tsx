...
function LoadingCard() {
  return (
    <div className="min-h-screen bg-ground text-ink flex items-center justify-center px-4">
      <div className="max-w-sm text-center">
        ...
        <div className="mt-6 flex justify-center">
          <div className="w-6 h-6 border-2 border-line border-t-brand rounded-full animate-spin" />
        </div>
      </div>
    </div>
  );
