...
const section =
  "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-white/10";
    ...
    <div className="min-h-screen bg-ground text-white">
      ...
      <section className={section}>
        <div className="max-w-3xl">
          ...
          <h2 className="text-3xl font-bold mb-8">From your address to the full picture</h2>
      ...
      <section className={section}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl">
          ...
          <div className={card}>
            <h3 className="font-semibold text-lg mb-4">With a free account</h3>
            <ul className="space-y-2 text-sm opacity-90">
              {[
      ...
      <section className={section}>
        ...
        <h2 className="text-3xl font-bold mb-3">No black boxes</h2>
        <p className="opacity-80 leading-relaxed max-w-2xl mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className={card}>
            ...
            <p className="text-sm opacity-70">
              Source: <SourceLink href="https://open-meteo.com/en/docs/air-quality-api" label="Open-Meteo" />
            </p>
            <p className="text-sm opacity-80 mt-3 leading-relaxed">
          ...
          <div className={card}>
            ...
            <p className="text-sm opacity-70">
              Source: <SourceLink href="https://www.epa.gov/frs" label="EPA Facility Registry Service" />
            </p>
            <p className="text-sm opacity-80 mt-3 leading-relaxed">
      ...
      <section className={section}>
        <div className="rounded-2xl border border-brand/25 bg-brand/[0.07] p-8 sm:p-12 text-center">
          ...
          <p className="opacity-80 max-w-xl mx-auto mb-8">
            It&apos;s free, and you don&apos;t need an account to start. Search your address and turn on
            the layers that matter to you.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              ...
              <Link href="/changes" className="opacity-60 hover:opacity-100 transition-opacity">
                Changes
              </Link>
              <Link href="/methodology" className="opacity-60 hover:opacity-100 transition-opacity">
                Methodology
              </Link>
